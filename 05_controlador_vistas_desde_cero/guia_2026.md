...
## 15. Ejecute por tercera vez la aplicación  
...
## 16. Detenga la aplicación

## 17. Agregue el siguiente código al final del archivo `Views` > `Prueba` > `Index.cshtml`  
...
## 18. Agregue la función `ListaPrecioMedio` en `PruebaController`  
...
## 19. Agregue una vista `Views` > `Prueba` > `ListaPrecioMedio.cshtml`
...
## 20. Ejecute por cuarta vez la aplicación.  
